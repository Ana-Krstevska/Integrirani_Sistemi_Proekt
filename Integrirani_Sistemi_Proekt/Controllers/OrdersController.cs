...
using Integrirani_Sistemi_Proekt.Data.ViewModels;
...
namespace Integrirani_Sistemi_Proekt.Controllers
{
    ...
    {
        private readonly IClothingsService _clothingsService;
        private readonly ShoppingCart _shoppingCart;
        private readonly IOrdersService _ordersService;

        public OrdersController(IClothingsService clothingsService, ShoppingCart shoppingCart, IOrdersService ordersService)
        {
